...
import (
	physConsul "github.com/openbao/openbao/v2/internal/physical/consul"
	csr "github.com/openbao/openbao/v2/internal/serviceregistration/consul"
)
...
// internal/command/commands.go stays byte-identical to upstream OpenBao and never
